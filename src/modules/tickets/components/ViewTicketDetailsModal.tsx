          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-primary-900/20 rounded-lg p-4 border border-blue-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h4 className="text-sm font-semibold text-primary-400">Usuario</h4>
              </div>
              <p className="text-primary-400 font-medium">ID: {ticket.user_id}</p>
            </div>

            <div className="bg-success/20 rounded-lg p-4 border border-green-200">
              <div className="flex items-center gap-2 mb-2">
                <FontAwesomeIcon icon={faUser} className="text-green-600" />
                <h4 className="text-sm font-semibold text-success">Técnico Asignado</h4>
              </div>
