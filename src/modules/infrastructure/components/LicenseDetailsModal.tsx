      ...
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto animate-slide-up">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="card p-4 text-center">
            <p className="text-sm text-secondary-600 mb-2">Estado de la Licencia</p>
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-secondary-50 rounded-lg p-4">
                <p className="text-xs text-secondary-600 mb-1">Tipo de Licencia</p>
                <p className="text-lg font-bold text-secondary-900">{getLicenseTypeText(license.license_type)}</p>
              </div>
              <div className="bg-secondary-50 rounded-lg p-4">
                <p className="text-xs text-secondary-600 mb-1">Proveedor</p>
                <p className="text-lg font-bold text-secondary-900">{license.provider}</p>
              </div>
            </div>
          </div>
          ...
          <div className="card p-6 bg-blue-50 border-blue-200">
            ...
            <div className="bg-white rounded-lg p-4 border-2 border-blue-200">
              <p className="font-mono text-lg text-center text-secondary-900 select-all">
                {license.license_key}
              </p>
            </div>
          ...
          <div className="card p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-secondary-700">Licencias en Uso</span>
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-secondary-600 mb-1">Fecha de Compra</p>
                <p className="font-bold text-secondary-900">{formatDate(license.purchase_date)}</p>
              </div>
              <div>
                <p className="text-sm text-secondary-600 mb-1">Fecha de Vencimiento</p>
                <p className="font-bold text-secondary-900">{formatDate(license.expiration_date)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="card p-6">
            ...
            <div className="bg-secondary-50 rounded-lg p-4">
              <p className="text-sm text-secondary-600 mb-1">Costo Anual</p>
          ...
          {license.notes && (
            <div className="card p-6 bg-amber-50 border-amber-200">
              ...
              <p className="text-secondary-700">{license.notes}</p>
            </div>
          )}
