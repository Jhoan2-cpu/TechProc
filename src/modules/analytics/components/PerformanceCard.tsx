    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex-1">
          ...
          <p className="text-sm text-secondary-600">{performance.course_name}</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-3">
        ...
        <div className="text-center p-2 bg-green-50 rounded">
          ...
          <p className="text-lg font-bold text-green-900">{performance.highest_score}</p>
        </div>
        <div className="text-center p-2 bg-red-50 rounded">
          <p className="text-xs text-secondary-600 mb-1">Más Baja</p>
          <p className="text-lg font-bold text-red-900">{performance.lowest_score}</p>
        </div>
        <div className="text-center p-2 bg-accent-50 rounded">
          <p className="text-xs text-secondary-600 mb-1">Aprobación</p>
          <p className="text-lg font-bold text-accent-900">{performance.passing_rate.toFixed(0)}%</p>
        </div>
