      ...
      <div className="bg-white rounded-lg shadow-xl max-w-lg w-full animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-secondary-50 rounded-lg p-4 border-2 border-secondary-200">
            <h4 className="font-heading font-bold text-secondary-900 mb-2">{incident.title}</h4>
            <p className="text-sm text-secondary-600 mb-3">{incident.description}</p>
            <div className="flex items-center gap-2">
              <span className="text-xs text-secondary-500">Estado actual:</span>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <p className="font-bold text-sm text-secondary-900">Abierto</p>
              </button>
              ...
              >
                ...
                <p className="font-bold text-sm text-secondary-900">Investigando</p>
              </button>
              ...
              >
                ...
                <p className="font-bold text-sm text-secondary-900">Resuelto</p>
              </button>
              ...
              >
                ...
                <p className="font-bold text-sm text-secondary-900">Cerrado</p>
              </button>
            </div>
          </div>
